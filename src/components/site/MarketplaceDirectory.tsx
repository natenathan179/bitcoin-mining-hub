// The marketplace directory renders all 1,000+ location links and owns the
// filter UI. It lives in its own module so the location dataset stays in this
// page's chunk instead of the bundle every visitor downloads.

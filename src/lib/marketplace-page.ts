/**
 * Location page composition — no location database import.
 *
 * Rendering one city page must not pull the 159 KB location JSON into the
 * request: parsing it on a cold worker isolate is what pushed concurrent
 * crawler traffic over the Cloudflare CPU limit and returned 5xx.
 */

  ...
  return (
    <SiteLayout>
      ...
      <PageHero
        ...
        subtitle="291 in-depth articles on choosing, buying, running and profiting from bitcoin mining hardware — every guide linked to the machines we hold in stock."
      />
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Search 291 mining guides..."
